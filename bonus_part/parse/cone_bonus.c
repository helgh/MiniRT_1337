...
/*   Updated: 2025/03/19 22:48:46 by hael-ghd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	cone_compenent(t_scene *scene, t_cone *cone)
{
	t_tmp_heap	*tmp;
	...
	{
		write(2, NORMAL_CO, ft_strlen(NORMAL_CO));
